...
import static com.kvvssut.codemonk.trees._t1_BinaryTreeImpl.*;
 ...
 */
public class _t2_BinarySearchTreeImpl {
	...
	/*
	 * Pre-order traversal follows the following strategy :- Process data of
	 * root node. Traverse left subtree completely first. Then traverse right
	 * subtree.
	 */
	...
	/*
	 * In post-order traversal: The root node is processed last, first process
	 * left subtree. Once left subtree is completed, process right subtree.
	 ...
	 * 
	 * If data of root node is greater, 1a. If left subtree exists, repeat step
	 * 1 with root = root of left subtree. 1b. Else, insert element as left
	 * child of current root. Else, 2a. If right subtree exists, repeat step 2
	 * with root = root of right subtree. 2b. Else, insert element as right
