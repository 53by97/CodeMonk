...
public class _q12_MirrorOfATreeWithoutRecursion {
	...
	/*
	 * (1) Call Mirror for left-subtree i.e., Mirror(left-subtree) (2) Call Mirror
	 * for right-subtree i.e., Mirror(right-subtree) (3) Swap left and right
	 * subtrees.
	 */
